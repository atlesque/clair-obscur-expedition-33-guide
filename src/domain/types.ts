...
export type SkillRecord = { id: string; name: string; cost: number; requires?: string[]; requiresAny?: string[][]; starting?: boolean; storyGated?: boolean; unsupportedPurchase?: boolean; acquisition?: 'points' | 'learned'; source?: string };
