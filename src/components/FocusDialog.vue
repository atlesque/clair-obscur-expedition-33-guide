...
.field-dialog .p-dialog-header-icon { width: 34px; height: 34px; border-radius: 2px; color: var(--card-muted); }
...
.field-dialog .p-button.p-button-text { color: var(--card-muted); }
